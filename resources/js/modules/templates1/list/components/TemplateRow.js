  ...
  return (<tr key={index}>
    ...
    <td>
      <div className="btn-group" role="group" aria-label="Actions">
        <Link className="btn btn-success mr-2" to={`templates1/${template.id}/editor`}>Add/Edit Template</Link>
        <Link className="btn btn-primary mr-2" to={`template1/${template.id}/edit`}>Edit</Link>
